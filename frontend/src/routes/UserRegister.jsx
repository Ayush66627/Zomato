    ...
    switch (name) {
      case "fullName":
        ...
        if (!nameRegex.test(value))
          return "Use letters and spaces (min 2 chars).";
        return "";
      case "email":
      ...
      case "password":
        ...
        if (!passwordRegex.test(value))
          return "Minimum 8 chars, at least one letter and one number.";
        return "";
      default:
        return "";
    }
      ...
      <div className="auth-card">
        ...
        <form className="form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="input">
            ...
            <div className="pw-row">
              ...
              <button
                ...
                onClick={() =>
                  setValues((s) => ({ ...s, showPassword: !s.showPassword }))
                }
                aria-label={
          ...
          <div className="muted">
            ...
            <Link className="links" to="/partner/register">
